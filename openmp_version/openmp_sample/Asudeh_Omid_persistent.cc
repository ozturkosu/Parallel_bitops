 ...
 * File:   main.cc
 * Author: omid
 * Created on October 19, 2016, 1:47 PM
 * test
 */
#include <fstream>
#include <vector>
...
{
    cout<<"Usage: ./persistent affect_rate epsilon num_threads < input_test_file\n";
    cout<<"***************************************************************\n";
